...
*/
typedef Callback< void, uint16_t, Ptr<SpectrumValue> > LtePhyRxPssCallback;//dwb

typedef Callback< void, uint16_t, Ptr<SpectrumValue>,bool,bool,int > LtePhyRxPSSCallback;//dwb
...
private:
  ...
  */
  ...
  LtePhyRxPSSCallback  m_ltePhyRxPSSCallback; ///< the LTE phy receive PSS callback dwb
