...
PyNs3CsmaNetDevice__PythonHelper::_wrap_DoInitialize(PyNs3CsmaNetDevice *self)
{
    ...
    if (helper == NULL) {
        PyErr_SetString(PyExc_TypeError, "Method DoInitialize of class CsmaNetDevice is protected and can only be called by a subclass");
        return NULL;
    }
    helper->DoInitialize__parent_caller();
    Py_INCREF(Py_None);
...
PyNs3CsmaNetDevice__PythonHelper::_wrap_NotifyNewAggregate(PyNs3CsmaNetDevice *self)
{
    ...
    if (helper == NULL) {
        PyErr_SetString(PyExc_TypeError, "Method NotifyNewAggregate of class CsmaNetDevice is protected and can only be called by a subclass");
        return NULL;
    }
    helper->NotifyNewAggregate__parent_caller();
    Py_INCREF(Py_None);
