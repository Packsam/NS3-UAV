...
PyNs3PointToPointNetDevice__PythonHelper::_wrap_DoInitialize(PyNs3PointToPointNetDevice *self)
{
    ...
    if (helper == NULL) {
        PyErr_SetString(PyExc_TypeError, "Method DoInitialize of class PointToPointNetDevice is protected and can only be called by a subclass");
        return NULL;
    }
    helper->DoInitialize__parent_caller();
    Py_INCREF(Py_None);
...
PyNs3PointToPointNetDevice__PythonHelper::_wrap_NotifyNewAggregate(PyNs3PointToPointNetDevice *self)
{
    ...
    if (helper == NULL) {
        PyErr_SetString(PyExc_TypeError, "Method NotifyNewAggregate of class PointToPointNetDevice is protected and can only be called by a subclass");
        return NULL;
    }
    helper->NotifyNewAggregate__parent_caller();
    Py_INCREF(Py_None);
