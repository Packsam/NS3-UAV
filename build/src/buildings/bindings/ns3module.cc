...
static PyObject*
_wrap_PyNs3OutdoorPositionAllocator__tp_richcompare (PyNs3OutdoorPositionAllocator *PYBINDGEN_UNUSED(self), PyNs3OutdoorPositionAllocator *other, int opid)
{
    
    if (!PyObject_IsInstance((PyObject*) other, (PyObject*) &PyNs3OutdoorPositionAllocator_Type)) {
        Py_INCREF(Py_NotImplemented);
        return Py_NotImplemented;
    }
    switch (opid)
...
PyTypeObject PyNs3OutdoorPositionAllocator_Type = {
    ...
    (richcmpfunc)_wrap_PyNs3OutdoorPositionAllocator__tp_richcompare,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)NULL,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
